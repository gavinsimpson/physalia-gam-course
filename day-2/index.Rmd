...
date: "1400&ndash;2000 CET (1300&ndash;1900 UTC) Tuesday 15th, 2022"
output:
...
.center[
```{r draw-mcycle, echo = FALSE, out.width = "85%"}
```
]
...
.center[
```{r draw-four-fun-sim-plot, echo = FALSE, out.width = "85%"}
draw(m_sim)
```
]
...
.center[
```{r draw-mcycle-options-plot, out.width = "85%", echo = FALSE}
