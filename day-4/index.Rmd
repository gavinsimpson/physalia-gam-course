...
date: "1400&ndash;2000 CET (1300&ndash;1900 UTC) Thursday 23rd November, 2023"
output:
...
`fitted_samples()`, `smooth_samples()` etc default to Gaussian approximation, but the Metropolis Hastings sampler is now an option in the development version
